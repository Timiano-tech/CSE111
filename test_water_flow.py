# test_water_flow.py
# testing all my functions to make sure they work right
...
def test_water_column_height():
    # checking water column height calculations
...
def test_pressure_gain_from_water_height():
    # testing pressure from water height
...
def test_kpa_to_psi():
    ...
    assert kpa_to_psi(6.895) == approx(1.0, abs=0.001)  # about 1 psi
